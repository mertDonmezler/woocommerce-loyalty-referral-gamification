...
class WPGamify_Activator {
    ...
    private static function seed_levels(): void {
        ...
        $levels = [
            ...
            [
                'level_number' => 3,
                'name'         => __( 'Koleksiyoncu', 'wp-gamify' ),
                'xp_required'  => 500,
                'benefits'     => '{"discount":5}',
                'color_hex'    => '#3b82f6',
            ],
